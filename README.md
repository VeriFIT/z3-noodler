...
Z3-Noodler is based on the SMT solver [Z3 v5.0.0](https://github.com/Z3Prover/z3/releases/tag/z3-5.0.0), in which it replaces the solver for the theory of strings. 
